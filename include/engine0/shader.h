...
void e0_setu_bool(e0_shader *s, const GLchar *uniform_name, bool);
void e0_setu_int(e0_shader *s, const GLchar *uniform_name, int);
void e0_setu_float(e0_shader *s, const GLchar *uniform_name, float);
void e0_setu_vec3(e0_shader *s, const GLchar *uniform_name, vec3);
void e0_setu_mat4(e0_shader *s, const GLchar *uniform_name, mat4);
